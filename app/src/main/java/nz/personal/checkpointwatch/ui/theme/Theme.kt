 ...
 * purple, which would show up the first time a component reached for a role this app does not use
 * often (a tertiary container in a snackbar, say).
 */
val CheckpointDarkColors: ColorScheme = darkColorScheme(
    primary = DarkPrimary,
...
val CheckpointLightColors: ColorScheme = lightColorScheme(
 ...
 *
 * @param darkTheme overridable so previews and screenshot tests can render both themes.
 */
@Composable
fun CheckpointWatchTheme(
